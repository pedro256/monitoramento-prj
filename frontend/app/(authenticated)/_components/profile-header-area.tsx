...
export default function ProfileHeaderArea() {
  ...
  const handledEmail = user.email.split("@")[0] || "[Usuário]";
    ...
    <Popover>
      ...
      <PopoverContent className="w-80 border border-border">
        ...
        <div className="flex flex-col mt-3 text-xs gap-1">
          ...
          <div onClick={logout} className="border border-destructive/25 px-1 py-2  rounded hover:bg-background/50 cursor-pointer">
